...
def contest_join_keyboard(contest_id, participants=None):
    ...
    - Har bir ishtirokchi ostida "➕ <Ism>" tugmasi — buni bosgan HAR QANDAY kishi,
      hech qanday tasdiqsiz, darhol o'sha ishtirokchiga 1 ball qo'shadi (oson, tez).
    - Pastda "🎮 Men ham ishtirok etaman!" — hali ro'yxatda yo'q kishilar uchun."""
    kb = InlineKeyboardBuilder()
    if participants:
